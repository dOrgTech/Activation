> This is a sample submission for the dOrg activation challenge. Read the instructions for submitting your own hack [here](https://docs.dorg.tech/getting-started/activation)
